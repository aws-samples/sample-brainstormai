...
# Set S3_BUCKET to your deployed assets bucket name and CHUNK_KEY to any valid chunk file.
S3_BUCKET = os.environ.get("S3_BUCKET", "brainstormai-assets-<your-account-id>")
CHUNK_KEY = os.environ.get("CHUNK_KEY", "chunks/<your-source-id>.json")
