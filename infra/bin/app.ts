...
// WS_CALLBACK_URL is set automatically after ApiStack deploys. On first deploy, leave blank
// and update after the WebSocket stage URL is known (see README deploy instructions).
